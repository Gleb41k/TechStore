...
async def start(message: Message):
    ...
    if user_profile:
        ...
        kb = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🛍️ Магазин", web_app=WebAppInfo(url="https://gleb1.b3654yy2.beget.tech/5g"))],
        ...
        # Показываем только кнопку магазина
        kb = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🛍️ Магазин", web_app=WebAppInfo(url="https://gleb1.b3654yy2.beget.tech/5g"))]
        ])
        await message.answer(
            f"Привет, {message.from_user.first_name}! Для продолжения нажмите внизу кнопку 'Магазин' 👇",
            reply_markup=kb
        )
...
async def view_profile(call: CallbackQuery):
    ...
    if user_profile:
        ...
        await call.message.answer(
            f"Привет, {call.from_user.first_name}! Для продолжения нажмите внизу кнопку 'Магазин' 👇",
            reply_markup=kb
        )
    ...
    if user_favorites:
        ...
        kb = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🛍️ Перейти в магазин",
                                  web_app=WebAppInfo(url="https://gleb1.b3654yy2.beget.tech/5g"))],
